...
export default function AboutSection() {
  return (
    <section className="bg-white py-12 relative overflow-hidden">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-8 relative z-10">
        {/* Left Blob + Illustration for desktop */}
        <div className="flex-1 relative hidden md:flex justify-center items-center z-10 mt-10 md:mt-0">
          <svg
            className="absolute top-0 right-0 w-96 h-96 opacity-30 pointer-events-none"
            viewBox="0 0 200 200"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex-1 z-10 flex flex-col items-center text-center">
          ...
          {/* Blob + Illustration for mobile, placed just after h2 */}
          <div className="relative flex justify-center items-center w-full mb-4 md:hidden">
            <svg
              className="absolute top-0 right-0 w-60 h-60 opacity-30 pointer-events-none"
              viewBox="0 0 200 200"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            >
            ...
            <img
              src="/images/Design-team.svg"
              alt="Market Research Illustration"
              className="w-40 h-40 drop-shadow-2xl relative"
            />
          </div>
